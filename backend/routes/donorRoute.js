...
import { authDonor,registerDonor,logoutDonor,getDonorProfile,updateDonorProfile,getDonors,deleterDonor,getDonorbyId,
    updateDonor,makeBloodReq,deleteBloodReq,getBloodReqById,updateBloodReq,findDonorByIdAndSendBloodRequest}
...
router.post('/make-blood-req',protect,makeBloodReq);
router.route('/blood-req/:requestId').delete(protect,deleteBloodReq).get(protect,getBloodReqById).put(protect,updateBloodReq);
