...
import { useCreatePublicBloodReqMutation } from '../slices/bloodRequestApiSlice'
...
function Publicblooddonationreqscreen() {
    ...
    const [createPublicBloodReq, { isLoading }] = useCreatePublicBloodReqMutation();
...
export default Publicblooddonationreqscreen